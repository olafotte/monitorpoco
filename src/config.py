...
DEFAULT_D_ON = 145.0     # cm abaixo do topo (Bomba 1 Liga)
DEFAULT_D_OFF = 168.0    # cm abaixo do topo (Bomba 1 Desliga)
DEFAULT_DIST_BORDA = 65.0 # cm profundidade padrão do sensor no poço

DEFAULT_D_ON2 = 115.0     # cm abaixo do topo (Bomba 2 Liga)
DEFAULT_D_OFF2 = 138.0    # cm abaixo do topo (Bomba 2 Desliga)
